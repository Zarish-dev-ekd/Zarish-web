...
export default function HeroSection({ hero }: HeroSectionProps) {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#FAF6F0] min-h-[580px] md:min-h-[600px] lg:min-h-[640px] flex items-end md:items-center">
      ...
      <div className="relative z-10 w-full md:hidden flex flex-col justify-end px-5 sm:px-8 pb-7 pt-16">
        ...
        <aside
          className="absolute top-4 right-4 z-20 pointer-events-none select-none -rotate-3"
          aria-hidden="true"
        >
          {hero?.overlay_text ? (
        ...
        {/* Eyebrow */}
        <div className="text-[10px] sm:text-xs font-semibold tracking-[0.25em] uppercase text-[#7B5B3A] mb-1.5 flex items-center">
        ...
        {/* Heading */}
        <h1 className="font-display text-3xl sm:text-4xl font-bold text-[#2C1D13] leading-[1.08] tracking-normal mb-2">
          {hero?.title ? (
        ...
        {/* Subtitle */}
        <p className="text-xs sm:text-sm text-[#6B5744] leading-relaxed mb-4 max-w-[340px]">
